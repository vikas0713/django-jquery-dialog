...
class Truck(models.Model):
    ...
    internal_notes=models.TextField(default='none')
...
class SingleDriver(models.Model):
    ...
    email=models.EmailField(null=True,default='me@pm.com')
...
class LoadModels(models.Model):
    ...
    driver=models.ForeignKey(SingleDriver, to_field='license_no',blank=True)
    truck=models.ForeignKey(Truck, to_field='truck_no',blank=True)
    trailer=models.ForeignKey(Trailer, to_field='trailer_no',blank=True)
